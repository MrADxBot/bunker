...
const CATASTROPHES = [
  ...
  { title: "Пандемия смертельного вируса", description: "Неизвестный вирус с летальностью 98% распространился по всему миру. Заражённые агрессивны и неуправляемы. Бункер — единственное безопасное место.", icon: "🛡️" },
  ...
  { title: "Восстание ИИ", description: "Суперинтеллект вышел из-под контроля и уничтожает человечество дронами-роботами. Бункер защищён от электромагнитных волн.", icon: "🛡️" },
  { title: "Глобальное потепление", description: "Уровень мирового океана поднялся на 50 метров. Большая часть суши затоплена. Токсичные газы делают воздух непригодным для дыхания.", icon: "🛡️" },
  { title: "Извержение супервулкана", description: "Йеллоустоун проснулся. Вулканический пепел покрывает всю Северную Америку. Температура упала на 15 градусов, солнечный свет заблокирован на годы.", icon: "🛡️" },
  { title: "Биологическое оружие", description: "Террористы выпустили разработанный в лаборатории патоген, который превращает людей в агрессивных мутантов. Единственное спасение — изоляция.", icon: "🛡️" },
  { title: "Магнитная буря класса X20", description: "Солнечная вспышка уничтожила все электросети и электронику. Цивилизация рухнула. Начался хаос и войны за ресурсы.", icon: "🛡️" },
];
...
const ACTION_CARDS = [
  { name: "Разведчик", description: "Вы можете тайно узнать одну скрытую характеристику любого игрока.", icon: "🛡️" },
  { name: "Переговорщик", description: "Один раз вы можете отменить голосование за себя и потребовать новое.", icon: "🛡️" },
  { name: "Шантажист", description: "Вы знаете секрет одного игрока. Раскройте его в любой момент для дискредитации.", icon: "🛡️" },
  { name: "Лидер", description: "Ваш голос считается за два при следующем голосовании.", icon: "🛡️" },
  { name: "Медик", description: "Один раз вы можете вылечить любого игрока от его болезни.", icon: "🛡️" },
  { name: "Сапёр", description: "Обнаруживаете скрытую угрозу — можете раскрыть ложь одного игрока.", icon: "🛡️" },
  { name: "Дипломат", description: "Можете спасти одного выбывшего игрока и вернуть его в игру.", icon: "🛡️" },
  { name: "Провокатор", description: "Устраиваете внеочередное голосование в любой момент игры.", icon: "🛡️" },
  { name: "Хранитель тайн", description: "Один из ваших атрибутов остаётся скрытым до конца игры.", icon: "🛡️" },
  { name: "Союзник", description: "Договоритесь с одним игроком — вас нельзя выгнать пока союзник в игре.", icon: "🛡️" },
  { name: "Обычный человек", description: "Нет специальных способностей. Всё в ваших руках!", icon: "👤" },
  { name: "Манипулятор", description: "Можете изменить один голос любого игрока на следующем голосовании.", icon: "🛡️" },
];
